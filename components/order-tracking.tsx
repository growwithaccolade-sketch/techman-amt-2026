...
export default function OrderTracking({ initialReference = "" }: { initialReference?: string }) {
  ...
  return (
    <section className="trackingPage shell">
      <div className="pageIntro"><span className="kicker">ORDER TRACKING</span><h1>See where your order stands.</h1><p>Use the order reference and the same email address you entered at checkout.</p></div>
      <div className="trackingLayout">
        ...
        <div className="trackingResult">
          {!order ? <div className="trackingEmpty"><PackageSearch size={38}/><h2>Your latest recorded status will appear here.</h2><p>Enter the order reference and checkout email to look it up.</p></div> : <>
