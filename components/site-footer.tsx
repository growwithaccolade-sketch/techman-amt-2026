...
export default function SiteFooter() {
  ...
  return <footer className="footer premiumFooter">
    <div className="shell premiumFooterTop">
      ...
      <div><b>Support</b>{supportLink && <a href={supportLink} target="_blank" rel="noreferrer">WhatsApp support</a>}<Link href="/faq">FAQs</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></div>
    </div>
